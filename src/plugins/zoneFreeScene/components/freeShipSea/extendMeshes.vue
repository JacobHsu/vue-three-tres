...
<template>
    <TresGroup>
        ...
        <Suspense>
            <ribbonArrow :position="[-135.023, 0.1, 10.726]" :rotation="[-1.55, 0, 0]" :scale="[5, 5, 5]" name="滾動箭頭元件"
        ...
        <Suspense>
            <ribbonArrow :position="[95.032, 0.1, -45.215]"
                ...
                name="滾動箭頭元件" uuid="13b3c540-85ec-4529-93e8-a00027f08a3a" :castShadow="false" :receiveShadow="false"
                :renderOrder="0" :visible="true" v-bind="eMeshState1" />
        </Suspense>

        <Suspense>
            <shapesforEditor :position="[13.619, 0.851, 24.773]" :rotation="[0, 0, 0]" :scale="[7, 1, 1]" name="圖形合集元件"
        ...
        <Suspense>
            <generalFont :position="[11.285, 1.3900000000000001, 24.641000000000002]"
                :rotation="[-1.6600000000000004, 0, 0]" :scale="[1, 1, 1]" name="標準三維字體"
        ...
        <Suspense>
            <lineArrow :position="[-5.89, 0.354, 22.939]"
                ...
                name="箭頭線元件" uuid="ea09fd01-9c32-4e07-838d-28a4d6379448" :castShadow="false" :receiveShadow="false"
        ...
        <Suspense>
            <lineArrow :position="[-16.14, 0.354, -30.504]"
                :rotation="[-1.5298976620779419, -0.07073732188678589, -1.5679040721375466]" :scale="[1.5, 1, 1.5]"
                name="箭頭線元件" uuid="3a2b9c28-5cb3-40c2-9811-4e06fcf7ed3a" :castShadow="false" :receiveShadow="false"
                :renderOrder="0" :visible="true" v-bind="eMeshState5" />
        </Suspense>

        <Suspense>
            <shapesforEditor :position="[2.387, 0.851, -27.739]" :rotation="[0, 0, 0]" :scale="[6.5, 1, 1]" name="圖形合集元件"
